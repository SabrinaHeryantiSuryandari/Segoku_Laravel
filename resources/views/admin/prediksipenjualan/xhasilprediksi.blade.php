...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card">
                <div class="card-header text-white" style="background-color: #4b49ac">Hasil Prediksi Penjualan</div>
                <div class="card-body">
                    <p class="make-bold">Hasil prediksi fuzzy time series untuk penjualan <span class="text-danger">{{ $menu }}</span> pada bulan <span class="text-danger">{{ $predictionYear }}</span> adalah <span class="text-danger"> {{ $predictionResult }}</span>.</p>
                </div>
                ...
                <div class="px-3" id="detail" style="display: none;">
                    ...
                    <table class="table table-condensed table-dang">
                        ...
                        @foreach ($data as $datum)
                            ...
                            <td><code>{{ $datum->penjualan }}</code></td>   
