...
<head>
    ...
    <title>LOGIN SISTEM INFORMASI SEGOKU</title>
                                    ...
                                    <form method="POST" action="{{ route('login') }}" >
                                        ...
                                        <div class="text-center">
                                            @if (Route::has('register'))
                                                @if (Route::has('register'))
                                                    <a class="btn btn-link" href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Belum Memiliki Akun</a>
                                                @endif
                                            @endif
                                        </div>                                 
                                    </form>
